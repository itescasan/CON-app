...
export class CambioPatrimonioComponent {
  ...
  V_Imprimir(): void {
    ...
    let dialogRef: any = this.cFunciones.DIALOG.getDialogById("wait");  
      ...
      this.GET.GetEstadoCambioPatromonio(this.cFunciones.DateFormat(this.val.Get("txtFecha").value, "yyyy-MM-dd"), this.cFunciones.DateFormat(this.val.Get("txtFecha").value, "yyyy-MM-dd"), this.val.Get("cmbMoneda").value).subscribe(
        {
          next: (data) => {  
          ...
          error: (err) => {  
            ...
            dialogRef.close();
            document.getElementById("btnReporte-CambioPatrimonio")?.removeAttribute("disabled");
