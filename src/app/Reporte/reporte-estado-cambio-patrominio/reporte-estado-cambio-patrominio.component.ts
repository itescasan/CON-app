...
@Component({
  selector: 'app-reporte-estado-cambio-patrominio',
  templateUrl: './reporte-estado-cambio-patrominio.component.html',
  styleUrl: './reporte-estado-cambio-patrominio.component.scss',
  standalone: false
})
export class ReporteEstadoCambioPatrominioComponent {
  ...
  V_Imprimir(): void {
      ...
      document.getElementById("btnReporte-EstadoCambioPatrominio")?.setAttribute("disabled", "disabled");  
      ...
      this.GET.GetEstadoCambioPatromonio(this.cFunciones.DateFormat(this.val.Get("txtFecha1").value, "yyyy-MM-dd"), this.cFunciones.DateFormat(this.val.Get("txtFecha2").value, "yyyy-MM-dd"), this.val.Get("cmbMoneda").value).subscribe(
        {
          next: (data) => {  
          ...
          error: (err) => {  
            ...
            dialogRef.close();
            document.getElementById("btnReporte-EstadoCambioPatrominio")?.removeAttribute("disabled");
    ...
    ngDoCheck(): void {
      ...
      this.val.addFocus("cmbMoneda", "btnReporte-EstadoCambioPatrominio", "click");
