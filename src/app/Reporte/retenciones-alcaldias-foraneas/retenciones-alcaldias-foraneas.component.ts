...
@Component({
  selector: 'app-retenciones-alcaldias-foraneas', 
  templateUrl: './retenciones-alcaldias-foraneas.component.html',
  styleUrl: './retenciones-alcaldias-foraneas.component.scss'
})
export class RetencionesAlcaldiasForaneasComponent {
  ...
  V_Imprimir(): void {
    ...
    document.getElementById("btnReporte-RetencionesAlcaldias")?.setAttribute("disabled", "disabled");
    ...
    this.GET.GetRetencionesAlcaldiasForaneas(this.cFunciones.DateFormat(this.val.Get("txtFecha1").value, "yyyy-MM-dd"), this.val.Get("cmbMoneda").value).subscribe(
      {
        next: (data) => {
        ...
        error: (err) => {
          ...
          dialogRef.close();
          document.getElementById("btnReporte-RetencionesAlcaldias")?.removeAttribute("disabled");
  ...
  ngDoCheck(): void {
    ...
    this.val.addFocus("cmbMoneda", "btnReporte-RetencionesAlcaldias", "click");
