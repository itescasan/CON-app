...
export class GastosCentroCostoComponent {
  ...
  V_Imprimir(): void {
    ...
    this.GET.GetGastosxCC(this.cFunciones.DateFormat(this.val.Get("txtFecha").value, "yyyy-MM-dd"),this.val.Get("cmbMoneda").value[0],   
  ...
  ngDoCheck(): void {
    ...
    this.val.addFocus("txtFecha", "cmbCentroCosto", undefined);
    this.val.addFocus("cmbCentroCosto", "cmbMoneda", undefined);
