...
export class RegistroIngresoCajaComponent {
  ...
  displayedColumns: string[] = ["Nombre_Cuenta","Fecha_Registro","Consecutivo","Usuario","Aplicado","Contabilizado","Aplicar", "Imprimir"];
  ...
  public v_CargarDatos(): void {
    ...
    dialogRef.componentInstance.mensaje = "<p class='Bold'>Esta Seguro Aplicar Este Reembolso? Una Ves Aplicado No Podra Modificar Sus Registro y Se Enviara Para Su Contabilización. </p>";
